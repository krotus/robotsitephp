...
class GUMP
{
        ...
        foreach ($this->errors as $e) {
            ...
            switch ($e['rule']) {
                ...
                case 'validate_valid_cc':
                    ...
                    break;
                case 'validate_valid_nif':
                    $resp[] = "The <span class=\"$field_class\">$field</span> field needs to contain a valid nif";
                    break;
        ...
        foreach ($this->errors as $e) {
            ...
            switch ($e['rule']) {
                ...
                case 'validate_valid_cc':
                    ...
                    break;
                case 'validate_valid_nif':
                    $resp[$field] = "The $field field needs to contain a valid nif";
                    break;
                case 'validate_valid_name':
    ...
    */
    ...
    /**
     * Determine if the input is a valid nif.
     * Usage: '<index>' => 'valid_nif'
     *
     * @param string $field
     * @param array  $input
     *
     * @return mixed
     */
    protected function validate_valid_nif($field, $input, $param = null)
    {
        ...
        if (strlen($input[$field]) != 9 || preg_match('/^[XYZ]?([0-9]{7,8})([A-Z])$/i', $input[$field], $matches) !== 1) {
            $valid = false;
        }
